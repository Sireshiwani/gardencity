...
class StaffUserCreationForm(TailwindMixin, UserCreationForm):
    class Meta:
        model = User
        fields = ("username", "full_name", "email", "role", "photo_url", "specialty", "commission_rate", "password1", "password2")
...
class StaffUserUpdateForm(TailwindMixin, forms.ModelForm):
    class Meta:
        model = User
        fields = ("username", "full_name", "email", "role", "photo_url", "specialty", "commission_rate", "is_active")
